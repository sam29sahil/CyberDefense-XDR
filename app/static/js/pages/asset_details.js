...
(function () {
  ...
  function getSeverityBadge(sev) {
    ...
    if (s === "critical") return `<span class="badge bg-danger-subtle text-danger text-uppercase fw-semibold">Critical</span>`;
    ...
    return `<span class="badge bg-info-subtle text-info text-uppercase fw-semibold">Low</span>`;
  }
